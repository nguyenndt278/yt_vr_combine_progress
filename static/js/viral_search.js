...
.append("g")
  .attr("transform", "translate(" + (width / 2 + margin.left) + "," + (height / 2 + margin.top) + ")");
   ...
   //legend
   svg.append("circle").attr("cx", -310).attr("cy", -300).attr("r", 8).style("fill", "#b1ecf8")
   svg.append("circle").attr("cx", -310).attr("cy", -270).attr("r", 8).style("fill", "#8ecad6")
   svg.append("circle").attr("cx", -310).attr("cy", -240).attr("r", 8).style("fill", "#6ea9b4")
   svg.append("circle").attr("cx", -310).attr("cy", -210).attr("r", 8).style("fill", "#2c6a75")
   svg.append("circle").attr("cx", -310).attr("cy", -180).attr("r", 8).style("fill", "#004d57")
   svg.append("text").attr("x", -290).attr("y", -330).text("Views (in Millions)").style("font-size", "16px").attr("alignment-baseline", "middle")
   svg.append("text").attr("x", -290).attr("y", -300).text(" < 1").style("font-size", "15px").attr("alignment-baseline", "middle")
   svg.append("text").attr("x", -290).attr("y", -270).text(" 1 - 5").style("font-size", "15px").attr("alignment-baseline", "middle")
  svg.append("text").attr("x", -290).attr("y", -240).text(" 5 - 10").style("font-size", "15px").attr("alignment-baseline", "middle")
  svg.append("text").attr("x", -290).attr("y", -210).text(" 10 - 20").style("font-size", "15px").attr("alignment-baseline", "middle")
  svg.append("text").attr("x", -290).attr("y", -180).text(" > 20").style("font-size", "15px").attr("alignment-baseline", "middle")
...
var y = d3.scaleRadial()
    ...
    .domain([0, 38000000]); // Domain of Y is from 0 to the max seen in the data
...
svg.append("g")
    ...
    .append("text")
      .text(function(d){return((parseFloat(d.view_name)/1000000).toLocaleString())})
