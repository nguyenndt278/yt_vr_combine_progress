...
el.addEventListener('click', function () {
    ...
    var el1 = document.getElementById("testButton1");
el1.addEventListener('click', function () {
    var text = document.getElementById("testBox1").value;
    var result = Bayes.extractWinner(Bayes.guess(text));
    document.getElementById("testBox1").value = '';
    document.getElementById("testResultLabel1").innerHTML = result.label;
    document.getElementById("testResultProbability1").innerHTML = Math.round(100 * result.score);
    document.getElementById("testResult1").style.display = 'block';
});}
// });}
